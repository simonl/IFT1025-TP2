...
public class Server {
    ...
    public void listen() throws IOException, ClassNotFoundException {
        ...
        if ((line = this.objectInputStream.readObject().toString()) != null) {
            // Si le client a bien envoyé l'entête de sa commande, on peut l'exécuter
    ...
    /**
     * Ferme la connexion client en cours.
     *
     * @throws IOException Si une erreur se produit avec la connexion.
     */
